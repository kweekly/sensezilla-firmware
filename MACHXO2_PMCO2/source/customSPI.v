...
/* Module Version: 1.1 */
/* C:\lscc\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n customSPI -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 2.06 -spi -spi_mode Slave -wb -dev 7000 -e  */
/* Thu Aug 29 17:42:34 2013 */


`timescale 1 ns / 1 ps
module customSPI (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
