...
/* Module Version: 1.1 */
/* C:\lscc\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n I2CSPI -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 7 -i2c2 -i2c2_freq 400 -i2c2_sa 1000010 -i2c2_addr 7 -wb -dev 7000 -e  */
/* Tue Sep 10 14:35:59 2013 */


`timescale 1 ns / 1 ps
module I2CSPI (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    defparam EFBInst_0.I2C2_CLK_DIVIDER = 5 ;
