...
// Mote
	...
	#elif HW_VERSION==2 || HW_VERSION==3
		#define MOTE_STATUS		REGISTER_BIT(PORTB,2)
		#define MOTE_STATUS_PIN REGISTER_BIT(PINB,2)
		#define MOTE_STATUS_PCINT 10
		#define MOTE_ASSOC		REGISTER_BIT(PORTB,1)
		#define MOTE_ASSOC_PCINT 9
		#define MOTE_ASSOC_PIN	REGISTER_BIT(PINB,1)
